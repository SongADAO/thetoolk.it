          ...
          <section className="mb-8">
            <div className="space-y-4">
              <p className="text-gray-700">
                ...
                cross-posting across social media. You can use this web version
                or{" "}
                <a
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  auctions, GBM auctions, InProcess, Forever Library, and more.
                </p>
              </div>
              ...
              <div className="rounded-xs border border-blue-200 bg-blue-50 p-4">
                ...
                <p className="mt-2 text-gray-700">
                  Since this project is open source, you&apos;re always welcome
                  to add features yourself!
                </p>
              </div>
            </div>
          </section>
          ...
          >
            <div className="mb-6 rounded-xs border border-yellow-200 bg-yellow-50 p-4">
              ...
              <p className="mt-2 text-yellow-700">
                ...
                make it easy for non-technical people. But you can definitely do
                it.
              </p>
            </div>
          ...
          >
            ...
            <div>
              ...
              <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
                ...
                <li>
                  In the sidebar, click on your project (it probably starts with
                  a string of numbers)
                  <ScreenshotButton
            ...
            <div>
              ...
              <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
                ...
                <li>
                  ...
                  these and save them in a safe place. Press <strong>OK</strong>{" "}
                  when you&apos;re done to close the popup.
                </li>
                <li className="font-medium text-red-600">
                  NEVER SHARE THESE WITH ANYONE
                </li>
