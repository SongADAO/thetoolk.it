...
import { AccordionSection } from "@/components/instructions/AccordionSection";
import { ScreenshotButton } from "@/components/instructions/ScreenshotButton";
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <div className="rounded-lg bg-white p-8 shadow-lg">
        ...
        <section className="mb-8">
          <div className="space-y-4">
            <p className="text-gray-700">
              ...
              cross-posting across social media. You can use this web version or{" "}
              <a
            ...
            <p className="text-gray-700">
              ...
              tried to make them as clear as possible, but every service has its
              own quirks!
            </p>
            <p className="text-gray-700">
              Keep in mind, we don&apos;t get access to any of your API keys or
              credentials for any of these sites; they are saved locally on your
              browser.
            </p>
          </div>
        </section>
        ...
        {/* Roadmap Section */}
        <section className="mb-8">
          <h2 className="mb-4 text-2xl font-semibold text-gray-800">Roadmap</h2>
          <div className="space-y-4">
            <div>
              <h3 className="mb-2 font-medium text-gray-700">Paid Version</h3>
              <p className="text-gray-600">
                If there&apos;s enough demand, we may offer a paid version that
                handles all API credentials for you—no setup required.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                approved, we&apos;ll update these instructions with steps to get
                your own access.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Coming soon: Manifold minting, Zora coins, Rodeo, NFT auctions,
                GBM auctions, InProcess, Forever Library, and more.
              </p>
            </div>
            ...
            <div className="rounded border border-blue-200 bg-blue-50 p-4">
              ...
              <p className="mt-2 text-gray-700">
                Since this project is open source, you&apos;re always welcome to
            ...
            <div>
              ...
              <div className="mb-4 rounded border border-red-200 bg-red-50 p-4">
                ...
                <p className="mt-2 text-red-700">
                  ...
                  it&apos;s better that you don&apos;t use Amazon S3! Take it
                  from me: It&apos;s very confusing and can easily result in
                  huge accidental bills. Just use Pinata if you don&apos;t
                  already know how to use Amazon S3.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div>
                ...
                <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
                  ...
                  <li>
                    Copy your API Key, API Secret and JWT to a safe place (you
                    can&apos;t see them again after this)
                  </li>
        ...
        >
          <div className="mb-6 rounded border border-yellow-200 bg-yellow-50 p-4">
            ...
            <p className="mt-2 text-yellow-700">
              None of this makes any sense. I&apos;m sorry! They don&apos;t make
              it easy for non-technical people. But you can definitely do it.
            </p>
          </div>
              ...
              <div className="mb-6">
                ...
                <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
                  ...
                  <li>
                    ...
                    Instagram name into the box and hit Enter when you find it
                  </li>
                  <li>
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
                  ...
                  <li>
                    If you have a business portfolio, select it (if you want).
                    If you don&apos;t, just click <strong>Next</strong>
                  </li>
                  <li>
              ...
              <div className="mb-6">
                ...
                <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
                  ...
                  <li>
                    Copy the Threads app ID and Threads app secret and save them
                    somewhere safe
                    <ScreenshotButton
                  ...
                  <li>
                    Choose <strong>Threads Tester</strong>, then search for your
                    Threads profile and hit Enter when you find it
                    <ScreenshotButton
                  ...
                  <li>
                    Log in to the Threads account you&apos;ll want to post from
                  </li>
                  <li>
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
                  ...
                  <li>
                    Copy and save the App ID and App Secret from the top of the
                    page
                  </li>
                  <li className="font-medium text-red-600">
                    NEVER SHARE THESE WITH ANYONE
        ...
        >
          ...
          <div>
            ...
            <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
              ...
              <li>
                In the sidebar, click on your project (it probably starts with a
                string of numbers)
                <ScreenshotButton
              ...
              <li>
                Click <strong>Done</strong> and your Client ID and secret will
                pop up
              </li>
        ...
        >
          ...
          <div>
            ...
            <ol className="ml-4 list-inside list-decimal space-y-2 text-gray-600">
              <li>
                In a tab where you&apos;re logged into the YouTube account you
                want to use, go to:{" "}
                <a
                  className="text-blue-600 underline hover:text-blue-800"
              ...
              <li>
                ...
                <ul className="mt-2 ml-6 list-inside list-disc space-y-1">
                  <li>
                    App name: <strong>TheToolkit</strong> (or whatever you want,
                    just no special characters)
                  </li>
              ...
              <li>
                A popup will appear with your Client ID and secret - copy these
                and save them in a safe place. Press <strong>OK</strong> when
                you&apos;re done to close the popup.
              </li>
              <li className="font-medium text-red-600">
                NEVER SHARE THESE WITH ANYONE
              </li>
              ...
              <li>
                ...
                <strong>Add Users</strong> and add the email associated with the
                YouTube account you&apos;re using
                <ScreenshotButton
              ...
              <li>
                Click in the search bar at the top of the screen and search for{" "}
                <strong>youtube API</strong> and then click on{" "}
                <strong>YouTube Data API v3</strong>. On the screen that pops
                up, click to enable it.
                <ScreenshotButton
