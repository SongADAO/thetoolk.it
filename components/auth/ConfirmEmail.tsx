        ...
        <div className="space-y-4">
          {isPending ? (
            ...
            <>
              {message ? (
                <p
                  className="rounded-xs border border-gray-200 bg-gray-50 p-4 text-sm text-green-600"
                  role="alert"
                >
                  {message}
                </p>
              ...
              {error ? (
                <p
                  className="rounded-xs border border-gray-200 bg-gray-50 p-4 text-sm text-red-600"
                  role="alert"
                >
                  {error}
                </p>
              ...
              {error ? (
                <div className="rounded-xs bg-gray-50 p-4 text-sm text-blue-800">
